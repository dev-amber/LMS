...
const Dashboard = () => {
       ...
       const fetchDashhboardData=async()=>{
    ...
    <div className='min-h-screen flex flex-col items-start justify-between
     gap-8 md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <div className='space-y-5'>
        {/* create div three for three rows */}
       ...
       <div className='flex flex-wrap gap-5 items-center'>
        ...
        {/* data that display the enrolled students */}

        <div className=''>
       <h2 className='pb-4 text-lg font-medium'>Latest Enrolments</h2>
       {/* data that display in table*/}
       <div className='aflex flex-col items-center max-w-4xl w-full overflow-hidden 
