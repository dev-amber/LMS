  ...
  const addLecture = () => {
    ...
    chapters.map((chapter)=>{
      if(chapter.chapterId === currentChapterId){
        const newLecture={
          ...lectureDetails,
          lectueOrder: chapter.chapterContent.length > 0 ? chapter.
          chapterContent.slice(-1) [0].lectueOrder + 1: 1,
          lectureId: uniqueid()
        };
            ...
            <div key={chapterIndex} className='bg-white border rounded-lg mb-4'>
              ...
              {!chapter.collapsed && (
                <div className='p-4'>
                  {chapter.chapterContent.map((lecture, lectureIndex) => (
                    <div key={lectureIndex} className='flex justify-between items-center mb-2'>
                      <span>
                        ...
                        - {lecture.isPreviewFree === 'true' ? 'Free Preview' : 'Paid'}
                      </span>
                      <img
                        src={assets.cross_icon}
                        alt='Remove'
                  ...
                  <div
                    className='inline-flex bg-gray-100 py-2 px-4 rounded cursor-pointer mt-2'
              ...
              <div className='bg-white text-gray-700 p-4 rounded relative w-full max-w-md'>
                ...
                <div className='mb-4'>
                  <label className='flex items-center gap-2'>
                    <input
                      type='checkbox'
                      checked={lectureDetails.isPreviewFree === 'true'}
                      onChange={(e) =>
                        setLectureDetails({
                          ...lectureDetails,
                          isPreviewFree: e.target.checked ? 'true' : 'false',
                        })
                      }
                    />
                    Is Preview Free?
