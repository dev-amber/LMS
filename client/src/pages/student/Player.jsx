...
const Player = () => {
  ...
  onClick={() => toggleSection(index)}>
      ...
      <img src={assets.down_arrow_icon} alt='arrowicon'
        ...
        <p className='text-sm md:text-default'>{chapter.chapterContent.length} lectures - {calculateChapterTime(chapter)}</p>
         ...
         <div className={`overflow-hidden transition-all duration-300 ${openSections[index] ? 'max-h-96' : 'max-h-0'}`}>
           <ul className='list-disc md:pl-10 pr-4 pl-4 py-2 text-gray-600 border-t border-gray-300'>
             ...
             alt='play icon' className='w-4 h-4 mt-1' />
                  <div className='flex items-center justify-between w-full text-gray-800 text-xs md:text-default'>
                   <p>{lecture.lectureTitle}</p>
                     ...
                     <div className='felx items-center gap-2 py-3 mt-10'>
          ...
          <div  className=''>
            <YouTube videoId={playerData.lectureUrl.split("/").pop()} 
             ...
             <div className='flex justify-between items-center mt-1'>
              <p className=''>{playerData.chapter}.{playerData.lecture} {playerData.lectureTitle}</p>
