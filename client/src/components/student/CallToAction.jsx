...
const CallToAction = () => {
  return (
    ...
    <p className='text-gray-500 md:text-sm'>Incididunt sint fugiat pariatur cupidatat consectetur sit <br/>
       cillum anim id veniam aliqua proident excepteur commodo doea.</p>
